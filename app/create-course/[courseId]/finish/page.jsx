    ...
    return (
        <div className='px-10 md:px-20 lg:px-44 my-7'>
            ...
            <div className='mt-3 flex flex-row gap-2 items-center'>
                <h2>Course URL</h2>
                <h2 className='text-center text-gray-500 border p-2 rounded-lg flex gap-2 items-center cursor-pointer' onClick={async () => { await navigator.clipboard.writeText('http://localhost:3000/course/' + course?.courseId + '/start'); setCopied(true) }}>
